<HTML>
 ...
 <div class="d-flex flex-row  mb-3">
  ...
  <div class="col-md-3 b  offset-3 n   border  border-dark rounded-left border-right-0" style="height:77vh ">
    <img src="goldenexperience.png" alt="some text" width=300vh height=400vh class="mt-3">
  ...
  <div class="col-md-5 b  "style="height:77vh">
      ...
      <div class="col-md-10 b p-1 p" >
        <p class="h1 margin-top-2">Golden Experience </p>
        <p class="h6 offset-1 mt-2"> Gold Experience (ゴールド・エクスペリエンス (黄金体験) Gōrudo Ekusuperiensu), às vezes encurtado para Gold E (ゴールド・Ｅ) é a Stand primária de Giorno Giovanna, destacado em Vento Aureo. A principal habilidade de Gold Experience é a de transformar objetos inertes em seres vivos, sejam de origem vegetal ou animal, que Giorno então pode controlar. Atacar tais seres faz com que o dano seja refletido de volta ao atacante. Giorno pode desfazer a transformação a qualquer momento.</p>
        ...
        <p class="h1 margin-top-2">$  200,00 </p>
        <p class="h6 margin-top-2 text-al">ou R$  2.000,00 </p>
