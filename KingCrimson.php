<HTML>
 ...
 <div class="d-flex flex-row  mb-3">
  ...
  <div class="col-md-3 b  offset-3 n   border  border-dark rounded-left border-right-0" style="height:77vh ">
    <img src="king crimson.png" alt="some text" width=320vh height=400vh class="mt-3">
  ...
  <div class="col-md-5 b  "style="height:77vh">
      ...
      <div class="col-md-10 b p-1 p" >
        <p class="h1">King Crimson</p>
        <p class="h6 offset-1"> King Crimson (キング·クリムゾン, Kingu Kurimuzon), às vezes encurtado para K Crimson (﻿Ｋ・クリムゾン) é a Stand pertencente a Diavolo, destacado em Vento Aureo. Possui uma sub-Stand, Epitaph (エピタフ, Epitafu) que é utilizada principalmente por Doppio, a outra personalidade de Diavolo.</p>
