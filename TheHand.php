<HTML>
 ...
 <div class="d-flex flex-row  mb-3">
  ...
  <div class="col-md-3 b  offset-3 n   border  border-dark rounded-left border-right-0" style="height:77vh ">
    <img src="za hando.png" alt="some text" width=325vh height=400vh class="mt-3">
  ...
  <div class="col-md-5 b  "style="height:77vh">
      ...
      <div class="col-md-10 b p-1 p" >
        <p class="h1">The Hand</p>
        <p class="h6 offset-1"> The Hand é o stand pertencente a Okuyasu Nijimura. Seu nome é referência a banda "The Band".<br>
        The Hand possui o poder de eliminar espaço. Toda vez que ele ataca com sua mão direita, ele elimina o espaço onde o corte foi feito. Qualquer coisa atingida pelo ataque é desintegrada imediatamente
        </p>
        ...
        <p class="h1 margin-top-2">$  700,00 </p>
        <p class="h6 margin-top-2 text-al">ou R$  7.000,00 </p>
