<HTML>
 ...
 <div class="d-flex flex-row  mb-3">
  ...
  <div class="col-md-3 b  offset-3 n   border  border-dark rounded-left border-right-0" style="height:77vh ">
    <img src="crazydiamond.png" alt="some text" width=340vh height=400vh class="mt-3">
  ...
  <div class="col-md-5 b  "style="height:77vh">
      ...
      <div class="col-md-10 b p-1 p" >
        <p class="h1">Crazy Diamond </p>
        <p class="h6 offset-1"> Crazy Diamond (クレイジー・ダイヤモンド, Kureijī Daiyamondo) é a stand pertencente a Josuke Higashikata, fazendo sua aparição na Parte IV: Diamond is Unbreakable.<br>
        Crazy Diamond possui o poder de restaurar objetos quebrados e curar feridas de qualquer ser-vivo, não importa a gravidade do dano. Pode restaurar um objeto ao seu estado natural, assim como revertê-lo aos seus componentes originais.
        </p>
        ...
        <p class="h1 margin-top-2">$  500,00 </p>
        <p class="h6 margin-top-2 text-al">ou R$  5.000,00 </p>
