<HTML>
 ...
 <div class="d-flex flex-row  mb-3">
  ...
  <div class="col-md-1 b p-1 text-nowrap p"><button type="submit" class="btn b p-1 p " style="width:30vh" value="7">Villain Stand</button><br></div>
  <div class="col-md-1 b p-1 text-nowrap p"><button type="submit" class="btn b p-1 p " style="width:30vh" value="8">Items</button><br></div>
  </div>
        
     

  <div class="col-md-3 b  offset-3 n   border  border-dark rounded-left border-right-0" style="height:77vh ">
    <img src="starplatinum.png" alt="some text" width=340vh height=400vh class="mt-3">
  ...
  <div class="col-md-5 b  "style="height:77vh">
      ...
      <div class="col-md-10 b p-1 p" >
        <p class="h1">Star Platinum </p>
        <p class="h6 offset-1"> Star Platinum (星の白金スタープラチナ Sutā Purachina) é o stand pertencente a Jotaro Kujo, sendo representado pela carta "A Estrela" do tarô.<br>
Entre os primeiros Stands introduzidos, apresenta junto com Jotaro em três partes da série, o mais proeminente em Stardust Crusaders.
<br>Quando vivo, Star Platinum foi o stand mais forte vivo.</p>
<button type="submit" class="btn b  p text-nowrap dr offset-8 " style="" value="11">-</button>estoque
        ...
        <p class="h1 margin-top-2">$  20.000,00 </p>
        <p class="h6 margin-top-2 text-al">ou R$  200.000,00 </p>
