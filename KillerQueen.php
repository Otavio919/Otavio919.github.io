<HTML>
 ...
 <div class="d-flex flex-row  mb-3">
  ...
  <div class="col-md-3 b  offset-3 n   border  border-dark rounded-left border-right-0" style="height:77vh ">
    <img src="killer queen.png" alt="some text" width=310vh height=400vh class="mt-3">
  ...
  <div class="col-md-5 b  "style="height:77vh">
      ...
      <div class="col-md-10 b p-1 p" >
        <p class="h1">Killer Queen</p>
        <p class="h6 offset-1">Killer Queen (キラー・クイーン, Kirā Kuīn) é a Stand de Yoshikage Kira, e faz sua aparição na Parte IV: Diamond is Unbreakable.<br>
        Através do toque, Killer Queen pode energizar um objeto como se fosse uma bomba. Se um objeto energizado é tocado, a energia é transmitida do objeto ao alvo antes de explodir e (geralmente) destruir ele completamente.<br> Kira também pode detonar essa bomba quando ele quiser
        </p>
        ...
        <p class="h1 margin-top-2">$  1500,00 </p>
        <p class="h6 margin-top-2 text-al">ou R$  15000,00 </p>
