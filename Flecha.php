<HTML>
 ...
 <div class="d-flex flex-row  mb-3">
  ...
  <div class="col-md-3 b  offset-3 n   border  border-dark rounded-left border-right-0" style="height:77vh ">
    <img src="flecha.jpg" alt="some text" width=340vh height=400vh class="mt-3">
  ...
  <div class="col-md-5 b  "style="height:77vh">
      ...
      <div class="col-md-10 b p-1 p" >
        <p class="h1">Arco e Flecha </p>
        <p class="h6 offset-1">O Arco e Flecha são objetos poderosos introduzidos em Diamond is Unbreakable, onde se tornaram peças importantes para o enredo pela necessidade de procurá-las devido ao seu poder para criar novos usuários de Stand.
        <br> Foi revelado que sua influência data desde Stardust Crusaders, mas sendo utilizadas fora de cena.</p>
        ...
        <p class="h1 margin-top-2">$  2.000,00 </p>
