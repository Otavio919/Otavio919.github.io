<HTML>
 ...
 <div class="d-flex flex-row  mb-3">
  ...
  <div class="col-md-3 b  offset-3 n   border  border-dark rounded-left border-right-0" style="height:77vh ">
    <img src="stone free.png" alt="some text" width=330vh height=400vh class="mt-3">
  ...
  <div class="col-md-5 b  "style="height:77vh">
      ...
      <div class="col-md-10 b p-1 p" >
        <p class="h1">Stone Free </p>
        <p class="h6 offset-1">Stone Free é a stand pertencente a Jolyne Cujoh, protagonista da Parte VI: Stone Ocean.<br>
        Stone Free é uma stand de curto alcance, possuindo alto poder destrutivo e velocidade, com a qual golpeia ferozmente o adversário com o famoso grito deStar Platinum: Ora! Ora! Ora!
        </p>
