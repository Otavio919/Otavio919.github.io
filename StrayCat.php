<HTML>
 ...
 <div class="d-flex flex-row  mb-3">
  ...
  <div class="col-md-3 b  offset-3 n   border  border-dark rounded-left border-right-0" style="height:77vh ">
    <img src="stray cat.png" alt="some text" width=340vh height=400vh class="mt-3">
  ...
  <div class="col-md-5 b  "style="height:77vh">
      ...
      <div class="col-md-10 b p-1 p" >
        <p class="h1">Stray Cat</p>
        <p class="h6 offset-1"> Stray Cat é o stand pertencente a Tama. Seu nome é referência a banda de Rockabilly "Stray Cats".<br>
        Stray Cat possui a habilidade de manipular o ar a sua volta livremente. Ele geralmente o utiliza para disparar bolhas de ar e também para gerar uma bolha protetora em torno de si. 
        </p>
        ...
        <p class="h1 margin-top-2">$  10,00 </p>
        <p class="h6 margin-top-2 text-al">ou R$  150,00 </p>
