<HTML>
 ...
 <div class="d-flex flex-row  mb-3">
  ...
  <div class="col-md-3 b  offset-3 n   border  border-dark rounded-left border-right-0" style="height:77vh ">
    <img src="silver chariot.png" alt="some text" width=320vh height=400vh class="mt-3">
  ...
  <div class="col-md-5 b  "style="height:77vh">
      ...
      <div class="col-md-10 b p-1 p" >
        <p class="h1">Silver Chariot</p>
        <p class="h6 offset-1"> Silver Chariot ((銀の戦車) シルバーチャリオッツ, Shirubā Chariottsu) é o Stand de Jean Pierre Polnareff, aparecendo pela primeira vez na Parte III: Stardust Crusaders.<br>
        Silver Chariot é um Stand muito poderoso focado em combate: Todas as suas habilidades são de natureza destrutiva ou tem como objetivo ajudar ele em combate. Ele é um Stand incrivelmente ágil, capaz de atacar inimigos com incontáveis ataques e cortes de espada antes do oponente conseguir reagir. Ele também pode usar sua agilidade junto com sua força para defender e refletir ataques direcionados contra seu usuário.</p>
        ...
        <p class="h1 margin-top-2">$  350,00 </p>
        <p class="h6 margin-top-2 text-al">ou R$  3.500,00 </p>
