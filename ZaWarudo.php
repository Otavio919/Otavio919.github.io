<HTML>
 ...
 <div class="d-flex flex-row  mb-3">
  ...
  <div class="col-md-3 b  offset-3 n   border  border-dark rounded-left border-right-0" style="height:77vh ">
    <img src="za warudo.png" alt="some text" width=340vh height=400vh class="mt-3">
  ...
  <div class="col-md-5 b  "style="height:77vh">
      ...
      <div class="col-md-10 b p-1 p" >
        <p class="h1">Za Warudo</p>
        <p class="h6 offset-1"> The World (ザ・ワールド（世界）Za Warudo) é o Stand pertencente a Dio Brando, sendo representado pela carta de tarô "O Mundo"<br>
         A chave de poder que define The World é a sua capacidade de parar o tempo, permitindo apenas a si mesmo e Dio para agir dentro do período de tempo parado. Dado o estado enfraquecido de Dio durante a Parte III, essa habilidade só funciona em alguns segundos no sistema de referência de Dio antes que o tempo flua novamente. 
        </p>
        ...
        <p class="h1 margin-top-2">$  10.000,00 </p>
        <p class="h6 margin-top-2 text-al">ou R$  100.000,00 </p>
